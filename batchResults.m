...
% Specify the value of the resolution parameter `r` for each problem
resArray = [...
	48, 24, 32, 32, 24,...
	32, 32, 32, 24, 48,...
	32, 32, 32, 24, 32,...
...
resultsOrtho = generateExamples(cases, 0.1*ones(1,n), resArray(cases+1));

% Generate all results with beta=1.0 (prefer regular spacing)
resultsSpaced = generateExamples(cases, ones(1,n), resArray(cases+1));
